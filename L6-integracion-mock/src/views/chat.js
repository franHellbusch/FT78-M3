...
// 1. Estado del chat. Una sola fuente de verdad.
const state = {
  messages: [
    // Mensaje de bienvenida del personaje. Arranca con uno solo.
    { role: "character", text: "Hola, soy tu personaje favorito. Que queres saber?" },
  ],
...
function setupChat() {
  ...
  // Foco automatico al entrar a la vista.
  $input.focus();
}
